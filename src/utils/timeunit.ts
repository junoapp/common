...
export namespace TimeUnit {
  ...
  export const YEARMONTHDATEHOURSMINUTES: 'yearmonthdatehoursminutes' =
  ...
  export const HOURSMINUTESSECONDS: 'hoursminutesseconds' =
    'hoursminutesseconds';
  export const MINUTESSECONDS: 'minutesseconds' = 'minutesseconds';
  export const SECONDSMILLISECONDS: 'secondsmilliseconds' =
    'secondsmilliseconds';
  ...
  export const UTCYEARMONTHDATEHOURS: 'utcyearmonthdatehours' =
    'utcyearmonthdatehours';
  export const UTCYEARMONTHDATEHOURSMINUTES: 'utcyearmonthdatehoursminutes' =
  ...
  export const UTCHOURSMINUTESSECONDS: 'utchoursminutesseconds' =
    'utchoursminutesseconds';
  export const UTCMINUTESSECONDS: 'utcminutesseconds' = 'utcminutesseconds';
  export const UTCSECONDSMILLISECONDS: 'utcsecondsmilliseconds' =
  ...
  export const UTCYEARQUARTERMONTH: 'utcyearquartermonth' =
    'utcyearquartermonth';
}
...
export function isLocalSingleTimeUnit(
  timeUnit: string
): timeUnit is LocalSingleTimeUnit {
...
export function isUtcSingleTimeUnit(
  timeUnit: string
): timeUnit is UtcSingleTimeUnit {
...
export const UTC_TIMEUNIT_INDEX: Flag<UtcTimeUnit> = {
...
export const SET_DATE_METHOD: Record<LocalSingleTimeUnit, DateMethodName> = {
  year: 'setFullYear',
  month: 'setMonth',
  date: 'setDate',
  hours: 'setHours',
  ...
  for (const timeUnitPart of TIMEUNIT_PARTS) {
    if (containsTimeUnit(unit, timeUnitPart)) {
      switch (timeUnitPart) {
        ...
        default: {
          const { getDateMethod, setDateMethod } = dateMethods(
            timeUnitPart,
            isUTC
          );
...
function dateMethods(singleUnit: SingleTimeUnit, isUtc: boolean) {
  ...
  const setDateMethod = isUtc
    ? 'setUTC' + rawSetDateMethod.substr(3)
    : rawSetDateMethod;
  const getDateMethod =
    'get' + (isUtc ? 'UTC' : '') + rawSetDateMethod.substr(3);
...
export function getDateTimeComponents(
  timeUnit: TimeUnit,
